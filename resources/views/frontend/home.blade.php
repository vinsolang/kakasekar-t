...
<body class="font-kantumruy overflow-x-hidden">
    <section id="team-page" class="relative w-full bg-white">
        <!-- Header Wrapper -->
    ...
    shadow-md rounded-md"
                ...
                <div class="flex items-center">
                    ...
                    <nav class="hidden lg:flex text-[#1E3E0F] font-medium items-center">
                        ...
                        text-white font-medium {{ session()->get('locale') === 'km' }}">@lang('messages.home')</a>
                            </li>
                            <li><a href="{{ route('about') }}"
                                    class="hover:text-[#4FA428] {{ session()->get('locale') === 'km' }}">@lang('messages.about_Us')</a>
                            </li>
                            <li><a href="{{ route('product') }}"
                                    class="hover:text-[#4FA428]">@lang('messages.our_products')</a></li>
    ...
    transform translate-x-full transition-transform duration-300 ease-in-out lg:hidden z-50 flex flex-col 
     bg-white overflow-y-auto mt-[70px]">
                ...
                <div class="flex flex-col px-6 space-y-2">
                    ...
                    <a href="{{ route('product') }}" class="py-2 hover:text-[#4FA428]">
                        @lang('messages.our_products')</a>
                    ...
                    <div class="">
                        ...
                        <div id="activitiesDropdown" class="hidden flex flex-col pl-4 space-y-2">
                            <a href="{{ route('event') }}" class="py-1 hover:text-[#4FA428]">
                                @lang('messages.event')</a>
                            <a href="{{ route('news') }}" class="py-1 hover:text-[#4FA428]"> @lang('messages.news')</a>
                        </div>
                    </div>
                    <a href="{{ route('publication') }}" class="py-2 hover:text-[#4FA428]">
                        @lang('messages.our_publication')</a>
    ...
    bg-cover bg-center text-white px-4 lg:px-12" style="background-image: url('{{ asset('image/bg-home-page.jpg') }}');">
            ...
            <div class="text-center lg:mr-[120px]">
                <h3 class="text-[#1E3E0F] text-[22px] md:text-[28px] lg:text-[35px] font-bold">
                    @lang('messages.welcom')
                </h3>

                <h1 class="font-bold leading-tight text-center
    {{ session()->get('locale') === 'km'
    ? "font-['Kantumruy pro'] text-[30px] md:text-[50px] lg:text-[80px]"
    : 'font-sans text-[40px] md:text-[70px] lg:text-[100px]' }}">
                    @lang('messages.srun_chhlat')
                </h1>
    ...
    : 'font-sans text-[40px] md:text-[70px] lg:text-[100px]' }}">
                ...
                <h3 class="text-white text-[18px] md:text-[28px] lg:text-[35px] font-bold mt-2">
                    @lang('messages.agribusiness')
                </h3>

                <div class="w-[100px] md:w-[154px] h-[3px] lg:h-[4px] bg-[#1E3E0F] mt-4 mx-auto lg:mr-[270px]"></div>

                <h3
                    class="text-white text-[14px] md:text-[18px] lg:text-[20px] font-medium mt-4 {{ app()->getLocale() == 'km' ? 'text-[16px] md:text-[20px] lg:text-[22px] leading-7' : 'text-[14px] md:text-[18px] lg:text-[20px] leading-6' }}">
                    @lang('messages.innovation_from_nature')
                </h3>
                <h3 class="text-white text-[14px] md:text-[18px] lg:text-[20px] font-medium">
                    @lang('messages.heathy')
                </h3>
            </div>
            ...
            <div class="lg:flex hidden absolute top-0 left-0 w-full">
                <img src="{{ asset('image/layer-home.png') }}" alt="Layer" class="w-full object-cover">
            </div>
        </div>
        ...
        <section class="py-8 md:py-12 px-4 text-center bg-transparent shadow-none w-[50%] mx-auto" id="text-desc">
            ...
            <!-- Paragraphs -->
            <p
                class="text-[#1E3E0F] text-[13px] sm:text-[14px] md:text-[15px] lg:text-[16px] mt-4 md:mt-6 leading-relaxed text-left flex justify-center line-clamp-2-fallback">
                @lang('messages.title_home1')
            </p>

            <p
                class="text-[#1E3E0F] text-[13px] sm:text-[14px] md:text-[15px] lg:text-[16px] mt-4 leading-relaxed text-left flex justify-center line-clamp-2-fallback">
                @lang('messages.title_home2')
            </p>

            <p
                class="text-[#1E3E0F] text-[13px] sm:text-[14px] md:text-[15px] lg:text-[16px] mt-4 leading-relaxed text-left flex justify-center line-clamp-2-fallback">
                @lang('messages.title_home3')
            </p>
        </section>
    </section>

    <!-- Team Profiles -->
    <section id="group-product" class="w-full py-16 relative overflow-hidden mt-[30px]">

        <!-- Background -->
        <img src="{{ asset('image/back-product-team.png') }}" alt="Background"
            class="absolute inset-0 w-full h-full object-cover -z-10">

        <!-- Product Group -->
        <div class="relative flex justify-center items-center w-full px-4 mt-[-50px]">
            <img src="{{ asset('image/product_g/g-product.png') }}" alt="Product Group"
                class="w-full sm:w-3/4 md:w-full lg:w-2/5 xl:w-full 2xl:w-full max-w-[1200px] h-auto object-contain transition-all duration-500">
        </div>

    </section>

    {{-- Section Partner logo --}}
    <section id="partner-logo" class="2 py-12 flex flex-col items-center justify-center">
        <!-- Title -->
        <div class="title">
            <h1 class="text-center text-[#1E3E0F] font-bold text-[35px]">
                @lang('messages.partner')
            </h1>
        </div>
        <div class="logo-com grid sm:grid-cols-3 grid-cols-1 m-[40px] gap-10">
            @foreach ($showLogo as $logo)
                <img src="../../assets/logo/{{ $logo->thumbnail }}" alt=""
                    class="w-[150px] h-[150px] transform transition-transform duration-300 hover:scale-110">
            @endforeach
        </div>
    </section>
    {{-- Sectioi Strategic Partners --}}
    <section id="strategic-partners" class="2 py-12 flex flex-col items-center justify-center">
        <!-- Title -->
        <h1 class="font-inter font-bold text-[35px] leading-[42px] text-center text-[#1E3E0F] mb-8">
            @lang('messages.strategic')
        </h1>

        <!-- Logo -->
        @foreach ($showStrategic as $strategic)
            <div class="logo-com flex items-center justify-center">
                <img src="../../assets/strategic/{{ $strategic->thumbnail }}" alt=""
                    class="w-[225px] h-[225px] transform transition-transform duration-300 hover:scale-110">
            </div>
        @endforeach
    </section>
    {{-- Innovation Nature --}}
