...
<head>
    ...
    <title>@lang('messages.our_publication')</title>
    {{-- Link Icon --}}
...
<body class="overflow-x-hidden">
                ...
                <div class="flex items-center xl:space-x-10 space-x-2">
                    ...
                    <nav class="hidden lg:flex text-[#1E3E0F] font-medium items-center">
                        <ul class="flex flex-wrap justify-center gap-4 space-x-4 lg:gap-4 xl:gap-6 text-[15px] lg:text-[16px] items-center">
                            ...
                            <li class="mt-[-10px]"><a href="{{ route('publication') }}" class="px-4 lg:w-[150px] lg:h-[98px] flex items-center justify-center 
                        rounded-bl-[12px] rounded-tr-[12px] 
                        bg-gradient-to-b from-[#4FA428] to-[#1E3E0F] 
                        text-white font-medium">@lang('messages.our_publication')</a>
                            </li>
    ...
    shadow-md bg-white overflow-y-auto mt-[70px]">
        ...
        <!-- Hero Section -->
        <div class="relative w-full min-h-[600px] md:min-h-[800px] lg:min-h-[1000px] flex flex-col justify-center items-center bg-cover bg-center text-white px-4 sm:px-6"
            style="background-image: url('{{ asset('image/news.jpg') }}');">

            <!-- Title -->
            <h1 class="text-3xl sm:text-5xl md:text-7xl font-bold text-center">
                @lang('messages.our_publication')
            </h1>

            <!-- Underline -->
            <div class="w-24 sm:w-36 h-1 bg-white mt-4"></div>

            <!-- Description -->
            <div class="mt-8 max-w-3xl">
                <p class="text-base sm:text-lg md:text-xl font-normal text-left leading-relaxed">
                   @lang('messages.t1')
                </p>
            </div>
        ...
        <section class="py-12 px-4 text-center bg-transparent shadow-none">
            <p class="text-[#1E3E0F] text-[15px] line-clamp-2 text-center flex justify-center text-left">
                @lang('messages.t2')
            </p>
        </section>
    </section>
    ...
    <section id="conceptual">
        <div class="title text-center m-10 text-[#0F4634] font-black text-[30px]">
            <h1>Conceptual Framework</h1>
        </div>
        {{-- Image conceptual --}}
        <div class="framework">
            <img src="{{ asset('image/framework.png') }}" alt="" class="block m-auto">
        </div>
        {{-- Report of Kaksekor Project to download PDF --}}
        <div class="download-pdf m-10">
            <h1 class="text-center text-[#0F4634] font-normal text-3xl"> @lang('messages.t3')</h1>
            <a href="{{ route('download.pdf') }}" class="block m-auto w-[215px] h-[54px] flex items-center justify-center
          text-white font-semibold rounded-full
          bg-gradient-to-r from-[#4FA428] to-[#1E3E0F] hover:opacity-90 transition mt-4">
                @lang('messages.t4')
            </a>
        </div>
    </section>
