...
<head>
    ...
    <title>@lang('messages.contact_us')</title>
    {{-- Link Icon --}}
...
<body class="overflow-x-hidden">
    <section id="team-page" class="relative w-full bg-[#FFFFFF]" style="background: #FFFFFF;">
        ...
        text-[#1E3E0F] text-xs sm:text-sm lg:mt-2 xl:mt-6 lg:mr-[150px] space-y-2 lg:space-y-0 gap-2">
            ...
            <!-- Navigation -->
            <div class="relative z-[1000] flex items-center justify-between lg:justify-center px-4 lg:px-8 h-[70px] lg:h-[98px] 
                    ...
                    <nav class="hidden lg:flex text-[#1E3E0F] font-medium items-center overflow-visible">
                        <ul
                            ...
                            <li><a href="{{ route('about') }}"
                                    class="hover:text-[#4FA428]">@lang('messages.about_Us')</a></li>
                            ...
                            <li class="mt-[-10px]"><a href="{{ route('contact') }}" class="px-4 lg:w-[120px] lg:h-[98px] flex items-center justify-center 
                        rounded-bl-[12px] rounded-tr-[12px] 
                        bg-gradient-to-b from-[#4FA428] to-[#1E3E0F] 
                        text-white font-medium">@lang('messages.contact_us')</a></li>
                            <!-- Social -->
    ...
    shadow-md bg-white overflow-y-auto mt-[70px]">
        ...
        <!-- Hero Section -->
        <div class="relative w-full min-h-screen flex flex-col justify-center items-center bg-cover bg-center text-white px-4 sm:px-6 lg:px-12"
            style="background-image: url('{{ asset('image/back-contact-us.jpg') }}');">

            <!-- Dark Overlay (optional for readability on mobile) -->
            <!-- <div class="absolute inset-0 bg-black/30"></div> -->

            <!-- Content -->
            <section class="relative bg-cover bg-center text-white py-12 md:py-16 px-4 sm:px-6 lg:px-8 mt-[150px]">
                <div
                    class="container mx-auto flex flex-col lg:flex-row justify-between items-center lg:items-start gap-10 lg:gap-20">

                    <!-- Left: Visit Us -->
                    <div class="w-full lg:w-1/4 space-y-4 text-center lg:text-right mt-10 lg:mt-32 text-white">
                        <h2 class="text-lg md:text-xl font-bold">@lang('messages.follow_us')</h2>

                        <!-- Working Time -->
                        {{-- <p class="flex items-center justify-center lg:justify-end gap-2">
                            <span class="font-semibold">Working Time:</span>
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg" class="text-white">
                                <circle cx="12" cy="12" r="9" stroke="#FFFFFF" stroke-width="1.5" fill="none" />
                                <path d="M12 7.5V12.5L15.25 14.25" stroke="#FFFFFF" stroke-width="1.5"
                        ...
                        {{-- <p class="flex items-center justify-center lg:justify-end gap-2">
                            ...
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                ...
                                <rect x="3" y="5" width="18" height="16" rx="2" stroke="#FFFFFF" stroke-width="1.5"
                                    fill="none" />
                                <path d="M16 3v4M8 3v4" stroke="#FFFFFF" stroke-width="1.5" stroke-linecap="round" />
                                <path d="M7 11h10" stroke="#FFFFFF" stroke-width="1.25" stroke-linecap="round" />
                                <rect x="7" y="14" width="2" height="2" rx="0.4" fill="#FFFFFF" />
                                <rect x="11" y="14" width="2" height="2" rx="0.4" fill="#FFFFFF" />
                                <rect x="15" y="14" width="2" height="2" rx="0.4" fill="#FFFFFF" />
                            </svg>
                            Everyday
                        </p> --}}

                        <!-- Social Icons -->
                        <div class="flex gap-6 mt-6 justify-center lg:justify-end">
                            <a href="https://t.me/Kaksekar_Digital">
                            ...
                            <a href="https://youtube.com/channel/UC7dMOGFP5ZMsIuHi1pvKjRA?feature=shared">
                                <img src="{{ asset('image/icon-contact/vdo.png') }}" alt="video"
                                    class="w-8 h-8 transform transition-transform duration-300 hover:scale-110">
                            </a>
                            <a href="https://www.tiktok.com/@kaksekardigital?_t=ZS-8ythEex1VWk&_r=1">
                    ...
                    <!-- Center: Logo & Contact Info -->
                    <div class="w-full lg:w-2/4 text-center">
                        <!-- Logo -->
                        <div class="flex justify-center mb-6">
                            <img src="{{ asset('image/logo-contact-us.png') }}" alt="logo"
                                class="w-[80px] h-[80px] sm:w-[100px] sm:h-[100px] lg:w-[115px] lg:h-[115px] object-contain">
                        </div>

                        <!-- Title -->
                        <h1 class="text-3xl sm:text-5xl md:text-6xl lg:text-6xl xl:text-7xl font-bold">@lang('messages.contact_us')
                        </h1>

                        <!-- White Line -->
                        <div class="w-24 sm:w-32 md:w-40 h-1 bg-white mx-auto my-6 md:my-8"></div>

                        <!-- Description -->
                        <div class="text-base sm:text-lg md:text-xl mx-auto space-y-3 max-w-xl">
                            <p>@lang('messages.q1')</p>
                            <p>@lang('messages.q2')</p>
                            <p>@lang('messages.q3')</p>
                        </div>
                    </div>

                    <!-- Right: Company Info -->
                    <div class="w-full lg:w-1/4 space-y-3 text-center lg:text-left mt-10 lg:mt-32">
                        <h2 class="text-lg md:text-xl font-bold">@lang('messages.title_srun')</h2>
                        ...
                        <div class="mt-4 flex flex-col items-center lg:items-start">
                            <iframe
                                ...
                                width="100%" height="200" style="border:0; border-radius:0.5rem;" allowfullscreen=""
            ...
            <div class="lg:flex hidden absolute top-0 left-0 w-full">
                <img src="{{ asset('image/layer-contact-us.png') }}" alt="Layer" class="w-full object-cover">
            </div>
        </div>

        <div
            class="py-2 px-4 text-center text-sm font-bold text-[#1E3E0F] relative bottom-[40px] items-center justify-center">
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        if (activitiesBtn) {
            activitiesBtn.addEventListener('click', function (e) {
                ...
                activitiesIcon.classList.toggle('rotate-180');
            });
        }
    });
</script>
