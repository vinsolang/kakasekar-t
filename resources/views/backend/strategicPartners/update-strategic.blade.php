...
@section('content')
    ...
    @section('page-main-title')
        UPDATE STRATEGIC PARTNERS LOGO
    @endsection
    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="col-xl-12">
                <!-- File input -->
                <form action="{{ route('update.submitStrategic') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row col-12">
                                <div class="mb-3 col-12 preview">
                                    ...
                                    <img id="previewImage" src="{{ asset('assets/strategic/' . $row[0]->thumbnail) }}"
                                        alt="Logo Preview" style="max-width:150px; border:1px solid #ccc; padding:4px;">
                                </div>
                            </div>
                            <div class="mb-3">
                                <a href="{{ route('view_strategic') }}">
                                    <input type="button"
