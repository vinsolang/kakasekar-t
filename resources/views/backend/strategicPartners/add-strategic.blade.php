...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="col-xl-12">
                <!-- File input -->
                <form action="{{ route('submit.strategic') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row col-6">
                                <div class="mb-3 col-12">
                                    <label for="formFile" class="form-label text-danger">Name Strategic Partner</label>
                                    <input class="form-control" type="text" name="name" />
                                </div>
                            </div>
                            <div class="row col-6">
                                <div class="mb-3 col-12">
                                    <label for="formFile" class="form-label text-danger">Choose Photo Strategic Partners</label>
