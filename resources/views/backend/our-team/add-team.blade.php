                ...
                <form action="{{ route('submit.add.team') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-12">
                                 ...
                                 <div class="mb-3 col-12">
                                    ...
                                    <input class="form-control" type="text" name="name_km" />
                                </div>
                                <div class="mb-3 col-12">
                                    <label for="formFile" class="form-label text-[#0F4634]">Position Khmer</label>
                                    <input class="form-control" type="text" name="position_km" />
                                </div>
                                <div class="mb-3 col-12">
                                    <label for="formFile" class="form-label text-[#0F4634]">Description Khmer</label>
                                    <textarea name="description_km" class="form-control" cols="30" rows="5"></textarea>
                                </div>
                       ...
                       transition relative overflow-hidden">
                                            ...
                                            <img class="preview-image hidden absolute inset-0 m-auto w-[180px] h-[180px] object-cover rounded-full"
                                                alt="preview" />
