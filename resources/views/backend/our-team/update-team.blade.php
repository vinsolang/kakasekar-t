                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-12">
                                    ...
                                    <textarea name="update_description" class="form-control" cols="30"
                                        rows="5">{{$row[0]->description}}</textarea>
                                </div>
                                <div class="mb-3 col-12">
                                ...
                                <div class="mb-3 col-12">
                                    ...
                                    <input class="form-control" type="text" name="update_position_km"
                                        value="{{ $row[0]->position_km }}" />
                                </div>
                                <div class="mb-3 col-12">
                                    <label for="formFile" class="form-label text-[#0F4634]">Description Khmer</label>
                                    <textarea name="update_description_km" class="form-control" cols="30"
                                        rows="5">{{$row[0]->description_km}}</textarea>
                                </div>
