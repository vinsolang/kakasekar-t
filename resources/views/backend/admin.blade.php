      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        <div class="app-brand demo">
          <a href="{{ route('home') }}" class="app-brand-link">
            ...
            <div class="logo flex justify-between items-center ml-[-18px]">
              <img src="{{ asset('image/logo.png') }}" alt="" style="width: 60px; height: 60px;">
        ...
        <ul  class="menu-inner py-1">
          ...
          <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
              <i class="menu-icon tf-icons bx bx-run text-xl"></i>
              <div data-i18n="Layouts">Activities</div>
            </a>

            <ul class="menu-sub">
              <li class="menu-item">
                <a href="{{ route('view_activities') }}" class="menu-link">
                  <div data-i18n="Without menu">View Activity</div>
                </a>
              </li>
              <li class="menu-item">
                <a href="{{ route('add.activities') }}" class="menu-link">
                  <div data-i18n="Without menu">Add Activity</div>
                </a>
              </li>
            </ul>
          </li>
          ...
          <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
              <i class="menu-icon tf-icons bx bx-calendar-event text-xl"></i>
              <div data-i18n="Layouts">Event</div>
            </a>

            <ul class="menu-sub">
              <li class="menu-item">
                <a href="{{ route('view_event') }}" class="menu-link">
