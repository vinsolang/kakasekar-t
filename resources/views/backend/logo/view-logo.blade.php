                        ...
                        <tbody class="table-border-bottom-0">
                            @foreach ($row as $logo)
                                <tr>
                                    ...
                                    <td>
                                        <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                                            <img src="../../assets/logo/{{ $logo->thumbnail }}" alt="Avatar" style="width: 50px">
                                        </ul>
                                    </td>
                                    ...
                                    <td>
                                        <div class="dropdown position-static">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a class="dropdown-item" href="{{ route('update.logo', ['id'=>$logo->id]) }}"><i
                                                        class="bx bx-edit-alt me-1"></i> Edit</a>
                                                <a href="javascript:void(0);" class="dropdown-item remove-post-key"
                                                    data-id="{{ $logo->id }}" data-bs-toggle="modal"
